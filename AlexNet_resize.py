from tensorflow.keras.layers import Dense, Dropout, Activation, Flatten, Conv2D, MaxPooling2D,BatchNormalization, GlobalAveragePooling2D,Resizing
...
def model_(trainX,learningRate,dropoutRate,listOfDenseLayerSizes):
    ...
    model.add(Resizing(224,224,interpolation="bilinear",crop_to_aspect_ratio=True))



    model.add(Conv2D(96,(11,11),padding="same",activation='relu',strides=4))
